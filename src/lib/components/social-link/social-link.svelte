<script lang="ts">
  import Twitter from '$lib/static/icons/Twitter.svelte';
  import Web from '$lib/static/icons/Globe.svelte';
  import Ethereum from '$lib/static/icons/Ethereum.svelte';
  import Github from '$lib/static/icons/Github.svelte';
